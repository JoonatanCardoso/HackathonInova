      ...
      >
        ...
        <q-form>
          <q-card-section class="q-pt-none text-justify">
            Título*
            <q-input v-model="tituloOrc" dense outlined disable />
          </q-card-section>
          <q-card-section class="q-pt-none text-justify">
            Solicitante*
            <q-input v-model="empresaOrc" dense outlined disable />
          </q-card-section>
          <q-card-section class="q-pt-none text-justify">
            Ramo de atividade*
            <q-select v-model="ramoOrc" dense outlined disable />
          </q-card-section>
          <q-card-section class="q-pt-none text-justify">
            Baixe o arquivo que contém informações como descrição do
            produto/serviço (marca), preço unitário, quantidade, total, condição
...
export default {
  ...
  data () {
    return {
      ...
      data: '',
      time: '',
      tituloOrc: 'Produção de Xícaras',
      empresaOrc: 'Inova Porcelanas',
      ramoOrc: 'Fabricante de Porcelana',
      dataOrc: '28/05/2021',
      horaOrc: '08:00h'
    }
  },
